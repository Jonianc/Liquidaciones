...
require_once CL_LIQ_PATH . 'includes/class-audit.php';
...
add_action('plugins_loaded', function() {
    load_plugin_textdomain('liquidaciones-cl', false, dirname(plugin_basename(__FILE__)) . '/languages');
