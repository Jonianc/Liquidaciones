...
== Changelog ==
= 1.12.1 =
* Fix: el selector de períodos al crear/editar liquidaciones ahora usa la ventana automática del updater también en formularios (admin y frontend), evitando listas vacías cuando no había períodos cargados manualmente.
